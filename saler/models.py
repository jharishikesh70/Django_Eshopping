...
class Product(models.Model):
    Avilabel_Product = (("In Stock", 'In Stock'), ("Out Stock", 'Out Stock'))
    Star_Rating = (("⭐", '⭐'), ("⭐⭐", '⭐⭐'), ("⭐⭐⭐", '⭐⭐⭐'), ("⭐⭐⭐⭐", '⭐⭐⭐⭐'), ("⭐⭐⭐⭐⭐", '⭐⭐⭐⭐⭐'))
    ...
    Product_Status = models.CharField(default='0', max_length=300, choices=Avilabel_Product)
    desc = models.TextField()
    short_description_1 = models.CharField(max_length=5000, default="")
    short_description_2 = models.CharField(max_length=5000, default="")
    short_description_3 = models.CharField(max_length=5000, default="")
    short_description_4 = models.CharField(max_length=5000, default="")
    short_description_5 = models.CharField(max_length=5000, default="")
    short_description_6 = models.CharField(max_length=5000, default="")
    short_description_7 = models.CharField(max_length=5000, default="")
    gst = models.CharField(default='0', max_length=3, choices=GST_CHOICES)
    Rating = models.CharField(default='0', max_length=100, choices=Star_Rating)
    Package_Dimensions = models.CharField(max_length=100, default=0)
    Item_Weight = models.CharField(max_length=100, default=0)
    Height = models.CharField(max_length=50, default="")
    Width = models.CharField(max_length=50, default="")
    color = models.CharField(max_length=50, null=True)
    seeds_per_pack = models.CharField(max_length=50, null=True)
    Avilabel_date = models.DateField(null=True)
